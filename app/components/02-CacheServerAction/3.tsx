import {cachedFetchUser} from "@/app/components/02-CacheServerAction/cached-bff";

export async function CacheServerAction3() {
  ...
  return (
    <div className="border border-green-500 p-4 rounded-lg bg-green-50">
      ...
      <p className="text-sm text-green-700 mb-2">
        ...
        <code className="bg-green-100 px-1 rounded">&apos;fetchUser&apos;</code> OUTside of the function.
      </p>
